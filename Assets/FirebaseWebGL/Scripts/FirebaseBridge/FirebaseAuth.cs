...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseAuth
    {
        ...
        /// </summary>
        /// <param name="objectName"> Name of the gameobject to call the onUserSignedIn/onUserSignedOut of </param>
        /// <param name="onUserSignedOut"> Name of the method to call when the user sign out is successful. </param>
        /// <param name="OnSignOutFail"> Name of the method to call when the operation was unsuccessful. </param>
        [DllImport("__Internal")]
        public static extern void OnSignOut(string objectName, string onUserSignedOut,
            string OnSignOutFail);
